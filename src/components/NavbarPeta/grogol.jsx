    ...
    <div className="sticky top-0 z-50">
        <Navbar className="bg-base h-[11vh] p-3 sm:p-2 flex shadow-lg w-full">
          <NavbarBrand justify="left">
            ...
            <div className="ml-3">
              <p className="font-sfProDisplay font-semibold text-[#0F1820] leading-tight">
                PETA USAHA TANAMAN SAYURAN GROGOL
                <br />
                <span className="text-[1.2rem] font-bold font-sfProDisplay">DESA GROGOL</span>
              </p>
            </div>
          </NavbarBrand>
          ...
          <NavbarContent justify="end">
            ...
            <NavbarItem>
            <Link
              to="https://drive.google.com/drive/folders/1pzONLW0tLeVtiDPRrec7upbmAVedeeqK?usp=drive_link"
