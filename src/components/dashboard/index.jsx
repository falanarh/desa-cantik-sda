...
const Dashboard = () => {
  ...
  const handleEditClick = (item) => {
    ...
    const addNumberAttribute = (items) => {
    ...
    const updateData = async (data) => {
      setIsLoading(true);
      try {
        const response = await api5.put("/api/desa/" + data._id);
        await message.success("Berhasil menambahkan Desa!", 8);
                ...
                <thead>
                  <tr>
                    ...
                    <th onClick={() => sortTable("luas")}>
                      <span>Luas {getSortIcon("luas")}</span>
                    </th>
                    <th>
                      <span>Foto</span>
                    </th>
